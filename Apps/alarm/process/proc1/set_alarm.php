...
include_once ("../../../../error.php");
	...
	$cleansed = $sanitize->cleanData([$data->hour,$data->minute,$data->note,$data->day]);
	$feedback = $alarm_model->set_alarm($cleansed[0],$cleansed[1],$cleansed[2],$cleansed[3]);

	if($feedback == true){

		echo json_encode(["msg"=>'Alarm set',"sx"=>1,"key"=>$alarm_model->msg]);

	}else{

		echo json_encode(["msg"=>'Alarm not set',"sx"=>0]);
