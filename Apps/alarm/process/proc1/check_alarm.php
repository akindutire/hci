...
include_once ("../../../../error.php");
	...
	$cleansed = $sanitize->cleanData([$data->hour,$data->minute,$data->day]);
	$feedback = $alarm_model->check_alarm($cleansed[0],$cleansed[1],$cleansed[2]);

	if($feedback == true){

		echo json_encode(["msg"=>'time',"sx"=>1,"note"=>$alarm_model->msg[0],"alarm_day"=>$alarm_model->msg[1]]);

	}else{

		echo json_encode(["msg"=>'.',"sx"=>0]);
